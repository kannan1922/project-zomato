...
function Footer() {
  return (
    <div className='jk'>
      ...
      <footer className="sc-elhb8j-21 fgKeBV snipcss-anwgo">
        <div className="sc-elhb8j-22 bGfHbP">
          <section className="sc-elhb8j-2 gzcbGg">
            <img src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png?fit=around%7C198:42&crop=198:42;*,*" alt="Zomato logo" className="sc-elhb8j-1 ixsoFB" />
            <div className="sc-elhb8j-12 cvsUXu">
            </div>
            <section className="sc-elhb8j-10 jPUyxY">
              <div className="sc-18n4g8v-0 gAhmYY sc-10ugfab-1 gJYvaX">
                <div tabIndex={0} aria-labelledby="country-dropdown-label" className="sc-10ugfab-9 ceanFw">
                 
                  <span className="sc-10ugfab-5 erXsJY">
                  </span>
                  <div tabIndex={-1} aria-activedescendant="country-active_clqb05wwp00162v787qplnd4j" className="sc-10ugfab-6 jVHQYz">
                    <div className="sc-bke1zw-0 fIuLDK sc-10ugfab-0 iYiNyG">
                      <div className="sc-bke1zw-1 kvUFhz">
                        <div id="country-active_clqb05wwp00162v787qplnd4j" className="sc-10ugfab-4 fYFzFe">
                          <span width={45} className="sc-13tn0rn-0 DHMyd">
                          </span>
                          <span className="sc-10ugfab-3 dirNi">
                            India
                          </span>
                        </div>
                      </div>
                      <div className="sc-bke1zw-1 jfiZBb">
                        <div id="country-uae_clqb05wwp00162v787qplnd4j" className="sc-10ugfab-4 hVtcrz">
                          <span width={45} className="sc-13tn0rn-0 ehBfFg">
                          </span>
                          <span className="sc-10ugfab-3 dirNi">
                            UAE
                          </span>
                  ...
                  <div className="sc-10ugfab-7 epQgJy">
                    <span width={45} className="sc-13tn0rn-0 mtUrN">
                    </span>
                    <span className="sc-10ugfab-8 fyCgPB">
                      India
                    </span>
                    <i className="sc-rbbb40-1 iFnyeo" size={15} color="#1C1C1C">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width={15} height={15} viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" className="sc-rbbb40-0 jKmKoK">
                        <title>
                          chevron-down
                        </title>
              ...
              <div className="sc-elhb8j-12 cDEyWL">
              </div>
              <div className="sc-18n4g8v-0 gAhmYY">
                <div tabIndex={0} aria-labelledby="language-dropdown-label" className="sc-zqptxt-7 iFttwN">
                  <label id="language-dropdown-label" className="sc-zqptxt-1 jNqlkW">
                    Select Language
                  </label>
                  <div tabIndex={-1} aria-activedescendant="lang-active_clqb05whji0ek10mof2i2cvpu" className="sc-zqptxt-4 bvogHW">
                    <span className="sc-zqptxt-3 iWeJHV">
                    </span>
                    <section className="sc-zqptxt-2 kVcJCg">
                    </section>
                  </div>
                  <div className="sc-zqptxt-5 dOFWhj">
                    <i className="sc-rbbb40-1 iFnyeo" size={18} color="#1C1C1C">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width={18} height={18} viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" className="sc-rbbb40-0 iwHbVQ">
                        <title>
                          language-globe
                        </title>
                    ...
                    <span className="sc-zqptxt-6 iMPEip">
                      English
                    </span>
                    <i className="sc-rbbb40-1 iFnyeo" size={15} color="#1C1C1C">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width={15} height={15} viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" className="sc-rbbb40-0 jKmKoK">
          ...
          <div className="sc-bke1zw-0 fIuLDK sc-elhb8j-23 btDUHh">
            <div name="About Zomato" className="sc-bke1zw-1 sc-elhb8j-20 llOEHd">
              <h6 className="sc-elhb8j-18 gQXbfm">
                About Zomato
              </h6>
              <nav>
                           <p className="sc-elhb8j-16 dxcfRo">
                    Who We Are
                  </p>
            ...
            <div name="Zomaverse" className="sc-bke1zw-1 sc-elhb8j-20 jWound">
              <h6 className="sc-elhb8j-18 gQXbfm">
                Zomaverse
              </h6>
              <nav>
            ...
            <div className="sc-bke1zw-1 sc-elhb8j-20 dLsZWW">
              <div className="sc-elhb8j-9 gfYSur">
                <h6 className="sc-elhb8j-18 gQXbfm">
                  For Restaurants
                </h6>
                <nav>
            ...
            <div name="Learn More" className="sc-bke1zw-1 sc-elhb8j-20 jYhtHx">
              <h6 className="sc-elhb8j-18 gQXbfm">
                Learn More
              </h6>
              <nav>
            ...
            <div name="Social links" className="sc-bke1zw-1 sc-elhb8j-14 HEzmM">
              <h6 className="sc-elhb8j-8 fvpjYk">
                Social links
              </h6>
              <div className="sc-elhb8j-15 RAjVl">
               
                  <div className="sc-elhb8j-7 jBOGYb">
                    <i className="sc-rbbb40-1 iFnyeo" size={22} color="#1C1C1C">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width={22} height={22} viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" className="sc-rbbb40-0 cvuzKA">
              ...
              <section className="sc-elhb8j-11 eHuOnX">
          
                  <div height="4rem" width="13.7rem" className="sc-s1isp7-1 fxuOHl">
                    <div src className="sc-s1isp7-3 cVOEqG">
                    </div>
                    <img alt="image" src="https://b.zmtcdn.com/data/webuikit/9f0c85a5e33adb783fa0aef667075f9e1556003622.png" loading="lazy" className="sc-s1isp7-5 fyZwWD" />
                  </div>
                ...
                <div className="sc-elhb8j-12 cvsUXu">
                  ...
                  <div height="4rem" width="13.7rem" className="sc-s1isp7-1 fxuOHl">
                    ...
                    <img alt="image" src="https://b.zmtcdn.com/data/webuikit/23e930757c3df49840c482a8638bf5c31556001144.png" loading="lazy" className="sc-s1isp7-5 fyZwWD" />
                  </div>
                
              </section>
            </div>
          </div>
          <hr className="sc-elhb8j-13 bskCAo" />
          <p className="sc-elhb8j-5 kBllqA">
